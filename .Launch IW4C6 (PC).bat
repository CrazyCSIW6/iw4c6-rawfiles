...
echo Starting IW4C6...
usethebatfile_dontrunthisdirectly.exe +set fs_game "" +exec c6.cfg +set vid_xpos 0 +set vid_ypos 0 +set r_fullscreen 1 +set r_noborder 0 +set safeArea_adjusted_horizontal 1 +set safeArea_adjusted_vertical 1 +set cg_scoreboardPingText 0 +set iw4c6_xpscale 1 +set gpad_prompt 0
