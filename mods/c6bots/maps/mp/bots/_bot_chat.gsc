...
bot_chat_death_watch( killer, last_ks )
{
	...
	{
		case 0:
			message = "^" + ( randomint( 6 ) + 1 ) + "fuck off " + killer.name;
			break;
			
		case 1:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "NICE JFAG YOU FUCKING NIGGER" );
			break;
		...
		case 3:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "YOU CANT EVEN DO THAT " + killer.name + " fucking PRICK" );
			break;
		...
		case 5:
			message = ( "oh my god ^" + ( randomint( 6 ) + 1 ) + "FUCK OFF" );
			break;
		...
		case 7:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "oh my fucking god " + killer.name + " ^1YOU FUCKING SUCK" );
			break;
		...
		case 9:
			message = ( "FUCKING LAGGED" );
			break;
			
		case 10:
			message = ( "nice " + killer.name );
			break;
		...
		case 12:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "MOTHERFUCKING SHIT CUNT" );
			break;
			
		case 13:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "dude what the actual fuck" );
			break;
			
		case 14:
			message = ( "^" + ( randomint( 6 ) + 1 ) + killer.name + " you FUCKING ANNOYING CUNT" );
			break;
		...
		case 16:
			message = ( "I can't believe that just fucking happened bro" );
			break;
			
		case 17:
			message = ( killer.name + " FUCK OOOOOOOOOOOOOFFFFFFF" );
			break;
		...
		case 20:
			message = ( "^" + ( randomint( 6 ) + 1 ) + "fucking shit map" );
			break;
			
		case 21:
			message = ( killer.name + "FUCKING TANKER" );
			break;
		...
		case 27:
			message = ( "WTF " + killer.name );
			break;
			
		case 28:
			message = ( "IM DEAD BECAUSE " + level.players[ randomint( level.players.size ) ].name + " IS A FUCKING NIGGER" );
			break;
			
		case 29:
			message = ( level.players[ randomint( level.players.size ) ].name + ", please shut the fuck up" );
			break;
			
		case 30:
			message = ( "Wow " + level.players[ randomint( level.players.size ) ].name + " is a FUCKING BLOCKER CUNT" );
			break;
			
		case 31:
			message = ( "Next time GET OUT OF MY FUCKING WAY " + level.players[ randomint( level.players.size ) ].name + " YOU FUCKING DICKHEAD" );
			break;
			
		case 32:
			message = ( "Wow, I'm dead because " + killer.name + " is a fuckin tryhard..." );
			break;
		...
		case 35:
			message = ( "WOW, USE A REAL FUCKING GUN" );
			break;
		...
		case 40:
			message = ( "wow " + getMapName( getdvar( "mapname" ) ) + " is fucked up" );
			break;
		...
		case 42:
			message = ( "reported. " + killer.name );
			break;
			
		case 43:
			message = ( "THESE FUCKING SPAWNS ARE GONNA MAKE ME KILL MYSELF" );
			break;
			
		case 44:
			message = ( "im getting owned lmfao" );
			break;
		...
		case 48:
			message = ( "STOP FUCKING CAMPING FAGGOT" );
			break;
			
		case 49:
			message = ( "GOD FUCKING DAMNIT FUCK FUCK FUCK FUCK FUCK!!!" );
			break;
		...
		case 51:
			message = ( "lol " + getMapName( getdvar( "mapname" ) ) + " fukn sux" );
			break;
		...
		case 53:
			message = ( getMapName( getdvar( "mapname" ) ) + " is the worst fucking map i have ever seen" );
			break;
			
		case 54:
			message = ( "WHAT THE FUCK WERE THEY THINKING WHEN THEY CAME UP WITH THIS MAP" );
			break;
			
		case 55:
			message = ( killer.name + " is gonna get RAPED" );
			break;
			
		case 56:
			message = ( "this game is gonna make me hang myself" );
			break;
			
		case 57:
			message = ( "wow " + killer.name + " go outside and touch grass" );
			break;
		...
		case 62:
			message = ( "OH MY FUCKING GOD STOP FUCKING PLAYING THIS GAME " + killer.name + " YOU FUCKING FAGGOT WHORE" );
			break;
		...
		case 64:
			message = ( "dude can you level me up " + killer.name + "?" );
			break;
			
		case 65:
			message = ( "nice aimbot " + killer.name + ", FAGGOT" );
			break;
		...
		case 67:
			message = ( "that was crazy " + killer.name );
			break;

		case 68:
			message = ( "Oh LoOk At Me Im A PuSsY UsInG My FuCkINg ^1RIOT SHIELD" );
			break;

		case 69:
			message = ( "IM GOING TO CHOP YOUR NUTS OFF" );
			break;

		case 70:
			message = ( "^1NIGGER ^2NIGGER ^3NIGGER ^4NIGGER ^5NIGGER" );
			break;

		case 71:
			message = ( "FUCK THIS IM ON BLOGTV WITH MY FUCKING HANDS UP" );
			break;

		case 72:
			message = ( "SUCK MY BIG BLACK HAIRY BONER BITCH" );
			break;

		case 73:
			message = ( "FUUUUUUUUUCK YOOOOOOOOOOU" );
			break;

		case 74:
			message = ( "FUCK OFF TOWELHEAD" );
			break;

		case 75:
			message = ( "FLY A PLANE INTO THE TOWERS YOU FUCKING TOWELHEAD" );
			break;
	}
	...
	switch ( state )
	{
		case "start":
			switch ( randomint( 8 ) )
			{
				...
				case 1:
					self BotDoChat( 1, "Haa! time to watch this killcam." );
					break;

				case 2:
					self BotDoChat( 1, "checking ur killcam" );
					break;
					
				case 3:
					self BotDoChat( 1, "istg if ur a JFAG im gonna rape ur mom" );
					break;

				case 4:
					self BotDoChat( 1, "i bet you like justin bieber music you fucking faggot" );
					break;
					
				case 5:
					self BotDoChat( 1, "faggot!!! FAG FAG FAGGOT" );
					break;

				case 6:
					self BotDoChat( 1, "^1WHAT THE ACTUAL FUCK" );
					break;
					
				case 7:
					self BotDoChat( 1, "oh my fucking god bro" );
					break;
			}
		...
		case "stop":
			switch ( randomint( 6 ) )
			{
				...
				case 1:
					self BotDoChat( 1, "Got it on my capture card!" );
					break;

				case 2:
					self BotDoChat( 1, "jesus fucking christ ur retarded" );
					break;
					
				case 3:
					self BotDoChat( 1, "WTF WAS THAT BRUH" );
					break;

				case 4:
					self BotDoChat( 1, "this faggot" );
					break;
					
				case 5:
					self BotDoChat( 1, "what a fucking nigger" );
					break;
			}
