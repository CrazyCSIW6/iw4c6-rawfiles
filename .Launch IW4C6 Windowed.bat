...
echo Starting IW4C6...
usethebatfile_dontrunthisdirectly.exe +set fs_game "" +exec c6.cfg +set r_mode "1280x720" +set vid_xpos 317 +set vid_ypos 144 +set r_fullscreen 0 +set r_noborder 0 +set safeArea_adjusted_horizontal 0.85 +set safeArea_adjusted_vertical 0.85 +set cg_scoreboardPingText 0 +set cg_overheadNamesFont 2 +set cg_overheadNamesSize 0.6 +set cg_overheadRankSize 0.5 +set iw4c6_xpscale 1 +set gpad_prompt 0
